module.exports = [
"[project]/apps/safety-lms/.next-internal/server/app/api/public/course-sections/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/safety-lms/src/app/api/public/course-sections/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: sections, error } = await supabase.from("course_sections").select("*").eq("course_id", courseId).eq("is_published", true) // Only published sections
        .order("order_index", {
            ascending: true
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90b54d86._.js.map