module.exports = [
"[project]/apps/safety-lms/.next-internal/server/app/api/public/content-blocks/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/safety-lms/src/app/api/public/content-blocks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: contentBlocks, error } = await supabase.from("content_blocks").select("*").eq("section_id", sectionId).order("order_index", {
            ascending: true
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6f4f272._.js.map