module.exports = [
"[project]/apps/safety-lms/.next-internal/server/app/api/public/quiz-questions/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/safety-lms/src/app/api/public/quiz-questions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$safety$2d$lms$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerSupabaseClient"])();
        // Get quiz questions for the specified section
        const { data: quizQuestions, error } = await supabase.from("quiz_questions").select("*").eq("section_id", sectionId).eq("is_published", true) // Only published questions
        .order("order_index", {
            ascending: true
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d7bac6f._.js.map